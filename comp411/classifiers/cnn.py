...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out0 , cache0 =  conv_lrelu_pool_forward(X,W1, b1, conv_param, lrelu_param, pool_param)
        out1, cache1 = affine_lrelu_forward(out0,W2,b2, lrelu_param)
        out2, cache2 = affine_forward(out1,W3,b3)
        ...
        dx3,dW3,db3= affine_backward(dScores, cache2)

        dx2,dW2,db2= affine_lrelu_backward(dx3, cache1)

        dx1,dW1,db1= conv_lrelu_pool_backward(dx2, cache0)
